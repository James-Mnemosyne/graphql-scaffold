...
describe('Query', () => {
  it('with only basic object', async () => {
    ...
    expect(fs.readFileSync('testing/results/base/graphql/authorizers/queries/base/index.ts').toString()).toMatchSnapshot()
    ...
    expect(fs.readFileSync('testing/results/base/graphql/resolvers/queries/base/index.ts').toString()).toMatchSnapshot()
