...
describe('Query', () => {
  it('with only basic object', async () => {
    ...
    fs.writeFileSync('testing/results/multiple/graphql/schemas/queries/multiple/thing/schema.graphql', schemaFileContents)
    ...
    expect(fs.readFileSync('testing/results/multiple/graphql/authorizers/queries/multiple/index.ts').toString()).toMatchSnapshot()
    expect(fs.readFileSync('testing/results/multiple/graphql/authorizers/queries/index.ts').toString()).toMatchSnapshot()
    ...
    expect(fs.readFileSync('testing/results/multiple/graphql/resolvers/queries/multiple/index.ts').toString()).toMatchSnapshot()
    ...
    expect(fs.readFileSync('testing/results/multiple/graphql/schemas/queries/multiple/index.ts').toString()).toMatchSnapshot()
