...
exports.generateFixture = void 0;
...
function generateFixture(config) {
  ...
  return __awaiter(this, void 0, void 0, function () {
    var schema, ast, fixtureNodes, newResolve, queryNode, mutationNode, baseNode, fixtures;
    return __generator(this, function (_e) {
      switch (_e.label) {
        ...
        case 1:
          ...
          return [
            2 /*return*/,
            (fixtures === null || fixtures === void 0 ? void 0 : fixtures.length)
              ? fixtures[Math.floor(fixtures.length / 2)]
              : {},
          ];
      }
    });
