...
function generateFixtures(node, fixtureNodes, maxFixtures) {
  switch (node.variation) {
    ...
    case types_1.FixtureNodeVariation.UnionFixtureNode:
      var unionResults = (0, generateFixturesForUnionNode_1.generateFixturesForUnionNode)(
        node,
        fixtureNodes,
        maxFixtures
      );
    ...
    case types_1.FixtureNodeVariation.ListFixtureNode:
      var listResults = (0, generateFixturesForListFixtureNode_1.generateFixturesForListFixtureNode)(
        node,
        fixtureNodes,
        maxFixtures
      );
