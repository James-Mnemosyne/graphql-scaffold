...
function getResolverTypeName(resolverType) {
    return resolverType === types_1.ResolverType.Mutation ? 'Mutations' : resolverType === types_1.ResolverType.Query ? 'Queries' : '';
}
function getResolverBody(config) {
    ...
    return "import { ".concat(resolverTypeName, " } from 'graphql-retail/types';\n\n/**\n * ").concat(resolverName, " ").concat(lowercaseResolverType, "\n */\nexport const ").concat(resolverName, ": ").concat(resolverTypeName, "['").concat(resolverName, "'] = async function (\n  _parent,\n  input,\n  _context\n) {\n  // TODO implement\n  console.log('input', input);\n  throw new Error('Unsupported ").concat(lowercaseResolverType, " ").concat(resolverName, ".')\n};\n");
}
