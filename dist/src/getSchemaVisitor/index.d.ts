...
export declare function getNewResolve(result: Record<string, FixtureNode>): ((node: {
    readonly kind: any;
    readonly loc?: any;
    readonly value: any;
}, key: string | number, parent: ASTNode | readonly ASTNode[], path: readonly (string | number)[], ancestors: readonly (ASTNode | readonly ASTNode[])[]) => any) | ((node: {
    readonly kind: any;
    readonly loc?: any;
    ...
    readonly directives?: readonly any[];
    readonly fields?: readonly any[];
}, key: string | number, parent: ASTNode | readonly ASTNode[], path: readonly (string | number)[], ancestors: readonly (ASTNode | readonly ASTNode[])[]) => any);
