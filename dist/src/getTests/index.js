...
function getEnums(fixtures) {
    ...
    var matches = (_b = (_a = json
        .match(enumRegex)) === null || _a === void 0 ? void 0 : _a.map(function (match) { return match.split('123GeneratedEnumStart-').join('').split('-321GeneratedEnumEnd').join('').split('.')[0]; })) !== null && _b !== void 0 ? _b : [];
