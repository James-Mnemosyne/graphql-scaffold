...
function generateTypes(config) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, (0, load_1.loadSchema)(config.schemaFilePath, { loaders: [new graphql_file_loader_1.GraphQLFileLoader()] })];
                case 1:
                    schema = _e.sent();
                    ...
                    baseNode = (_b = (_a = queryNode === null || queryNode === void 0 ? void 0 : queryNode.fields) === null || _a === void 0 ? void 0 : _a.find(function (field) { return field.name === config.resolverName; })) !== null && _b !== void 0 ? _b : (_c = mutationNode === null || mutationNode === void 0 ? void 0 : mutationNode.fields) === null || _c === void 0 ? void 0 : _c.find(function (field) { return field.name === config.resolverName; });
                    fixtures = (0, generateFixtures_1.generateFixtures)(baseNode, fixtureNodes, (_d = config.maxFixtures) !== null && _d !== void 0 ? _d : 100);
                    result = (0, getTests_1.getTests)((fixtures === null || fixtures === void 0 ? void 0 : fixtures.length) ? fixtures : [{}], config);
